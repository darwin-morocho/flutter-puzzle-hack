...
import 'package:my_puzzle/src/ui/pages/game/widgets/game_app_bar.dart';
                    ...
                    Expanded(
                      child: LayoutBuilder(
                        builder: (_, constraints) {
                          ...
                          final puzzleHeight = (isPortrait ? height * 0.45 : height * 0.5)
                              .clamp(250, 700)
                              .toDouble();
                          final optionsHeight = (isPortrait ? height * 0.25 : height * 0.2)
                              .clamp(120, 200)
                              .toDouble();
